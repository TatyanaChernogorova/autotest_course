...
def letter_stat(our_str):
    """Подсчет количства букв"""
    letters_dict = dict()
    for letter in our_str:  # перебор списка, который поступает на вход
        letters_dict[letter] = letters_dict.get(letter, 0) + 1  # подсчет количества вхождений буквы
    return letters_dict
